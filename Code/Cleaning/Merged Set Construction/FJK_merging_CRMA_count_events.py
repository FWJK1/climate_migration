...
for start_year, end_year in from_2000_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Count/Inclusive/From_2000/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_3_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Count/Inclusive/Minus_3/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_5_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Count/Inclusive/Minus_5/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_10_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Count/Inclusive/Minus_10/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
###### SAVE FILES
from_2000_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Sets/From_2000.csv")
minus_3_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Sets/minus_3_long.csv")
minus_5_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Sets/minus_5_long.csv")
minus_10_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Sets/minus_10_long.csv")
