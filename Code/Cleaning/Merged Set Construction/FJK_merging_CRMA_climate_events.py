...
for start_year, end_year in from_2000_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Climate/Inclusive/From_2000/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_3_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Climate/Inclusive/Minus_3/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_5_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Climate/Inclusive/Minus_5/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
for start_year, end_year in minus_10_periods:
    df = pd.read_csv(f"{root}/Data/County/County_sum_with_StormEvents_Climate/Inclusive/Minus_10/inclusive_merge_countysum_storm_{start_year}_{end_year}.csv")
...
##Debug any missing columns
# missing_columns_2000 = [col for col in columns_to_drop if col not in from_2000_long.columns]
# missing_columns_minus_3 = [col for col in columns_to_drop if col not in minus_3_long.columns]
# missing_columns_minus_5 = [col for col in columns_to_drop if col not in minus_5_long.columns]
# missing_columns_minus_10 = [col for col in columns_to_drop if col not in minus_10_long.columns]

# print("Missing in from_2000_long:", missing_columns_2000)
# print("Missing in minus_3_long:", missing_columns_minus_3)
# print("Missing in minus_5_long:", missing_columns_minus_5)
# print("Missing in minus_10_long:", missing_columns_minus_10)
...
###### SAVE FILES
from_2000_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/From_2000.csv")
minus_3_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_3_long.csv")
minus_5_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_5_long.csv")
minus_10_long.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_10_long.csv")
