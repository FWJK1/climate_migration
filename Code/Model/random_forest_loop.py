...
mae_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/mae_results.csv")
r2_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/r2_results.csv")
importance_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/mean_importance.csv")
