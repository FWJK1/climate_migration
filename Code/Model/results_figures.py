...
mae_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/mae_results.csv", index_col=0)
r2_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/r2_results.csv", index_col=0)
importance_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/Results/mean_importance.csv", index_col=0)
...
plt.savefig(f"{root}/Figures/Results/MAE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/Results/R2_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/Results/importance_heatmap_full.png", dpi=300, bbox_inches='tight') 
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/Results/importance_heatmap_top20.png", dpi=300, bbox_inches='tight')
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/Results/importance_heatmap_top10_any.png", dpi=300, bbox_inches='tight')
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/Results/importance_heatmap_property_death.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/Results/MSE_bar.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(f"{root}/Figures/Results/feature_boxplot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/Results/MAE_R2_scatterplot.png", dpi=300, bbox_inches='tight')
