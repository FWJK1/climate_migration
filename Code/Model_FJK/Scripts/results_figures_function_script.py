...
#### IMPORT DATA
mae_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/mae_results.csv", index_col=0)
mse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/mse_results.csv", index_col=0)
rmse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/mse_results.csv", index_col=0)
baseline_mae_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/baseline_mae_results.csv", index_col=0)
r2_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/r2_results.csv", index_col=0)
importance_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_{paradigm}_Results/mean_importance.csv", index_col=0)

mae_results = mae_results.apply(pd.to_numeric, errors='coerce')
mse_results = mse_results.apply(pd.to_numeric, errors='coerce')
rmse_results = rmse_results.apply(pd.to_numeric, errors='coerce')
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/MAE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/MSE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/RMSE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/R2_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/importance_heatmap_full.png", dpi=300, bbox_inches='tight') 
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/importance_heatmap_top20.png", dpi=300, bbox_inches='tight')
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/importance_heatmap_top10_any.png", dpi=300, bbox_inches='tight')
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/importance_heatmap_property_death.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/MSE_bar.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/feature_boxplot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_{paradigm}_Results/MAE_R2_scatterplot.png", dpi=300, bbox_inches='tight')

# Display the plot
 


# Calculate the percentage difference between baseline and model mae
