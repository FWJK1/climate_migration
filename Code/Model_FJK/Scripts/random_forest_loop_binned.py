...
output_file = f'{root}/Code/Model_FJK/Output_Logs/binned_model_output_{current_time}.txt'
...
def forest_reg_search(X, y, param_grid=None, groups=None,  logged=True, **kwargs,):
    ...
    if not param_grid:
        param_grid = {
            "rf__n_estimators": [500, 700, 800],  # Number of trees
...
param_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/param_results.csv")
mae_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/mae_results.csv")
mse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/mse_results.csv")
rmse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/rmse_results.csv")
baseline_mae_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/baseline_mae_results.csv")

r2_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/r2_results.csv")
importance_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Binned_Results/mean_importance.csv")
