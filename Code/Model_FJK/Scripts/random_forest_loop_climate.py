...
##### Import data
datasets = {
    'from_2000': pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/From_2000.csv", usecols=lambda column: column != 'Unnamed: 0'),
    'minus_3': pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_3_long.csv", usecols=lambda column: column != 'Unnamed: 0'),
    'minus_5': pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_5_long.csv", usecols=lambda column: column != 'Unnamed: 0'),
    'minus_10': pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Sets/minus_10_long.csv", usecols=lambda column: column != 'Unnamed: 0')
}
...
param_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/param_results.csv")
mae_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/mae_results.csv")
mse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/mse_results.csv")
rmse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/rmse_results.csv")
baseline_mae_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/baseline_mae_results.csv")

r2_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/r2_results.csv")
importance_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Climate_Results/mean_importance.csv")
