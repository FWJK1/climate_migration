...
mae_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Results/mae_results.csv", index_col=0)
mse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Results/mse_results.csv", index_col=0)
rmse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Results/mse_results.csv", index_col=0)


r2_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Results/r2_results.csv", index_col=0)
importance_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Count_Results/mean_importance.csv", index_col=0)
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/MAE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/MSE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/RMSE_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/R2_heatmap.png", dpi=300, bbox_inches='tight') 
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/importance_heatmap_full.png", dpi=300, bbox_inches='tight') 
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_Count_Results/importance_heatmap_top20.png", dpi=300, bbox_inches='tight')
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_Count_Results/importance_heatmap_top10_any.png", dpi=300, bbox_inches='tight')
...
features_of_interest = ['disaster_count']
...
# Save the heatmap as a PNG file
plt.savefig(f"{root}/Figures/FJK_Count_Results/importance_heatmap_property_death.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/MSE_bar.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/feature_boxplot.png", dpi=300, bbox_inches='tight')
...
plt.savefig(f"{root}/Figures/FJK_Count_Results/MAE_R2_scatterplot.png", dpi=300, bbox_inches='tight')
