...
mae_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/mae_results.csv", index_col=0)
mse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/mse_results.csv", index_col=0)
rmse_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/rmse_results.csv", index_col=0)

r2_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/r2_results.csv", index_col=0)
importance_results = pd.read_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/mean_importance.csv", index_col=0)


mae_results = mae_results.apply(pd.to_numeric, errors='coerce')
mse_results = mae_results.apply(pd.to_numeric, errors='coerce')
...
# Create a heatmap
plt.figure(figsize=(10, 6))  # Adjust the figure size as needed
sns.heatmap(mse_results, annot=True, cmap="YlOrRd", cbar_kws={'label': 'MSE'}, fmt=".3f")
...
# Create a heatmap
plt.figure(figsize=(10, 6))  # Adjust the figure size as needed
sns.heatmap(rmse_results, annot=True, cmap="YlOrRd", cbar_kws={'label': 'RMSE'}, fmt=".3f")
...
death_features = [f'Total_{i}_death' for i in range(2, 7)]
