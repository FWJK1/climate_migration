...
mse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/mse_results.csv")
rmse_results.to_csv(f"{root}/Data/FINAL_FOR_MODEL/FJK_Results/rmse_results.csv")
